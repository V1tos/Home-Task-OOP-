...
int main() {
	setlocale(LC_ALL, "ru");
	//cout << "Написати клас Банківський рахунок (Account), який містить :";
//
//cout << "Номер рахунку";
//cout << "Розмір коштів на рахунку";
//cout << "Назва валюти рахунку(рублі, гривні, евро тощо), для позначення якої можна скористатись одним символом : R, G, E, $ тощо";
//cout << "Забезпечити можливість :";
//cout << "Відкривати рахунок та первинно вносити гроші на рахунок";
//cout << "Знімати гроші з рахунку";
//cout << "Докладати гроші на рахунок";
//cout << "ПРИМІТКА!На 12 балів реалізувати також можливість здійснювати переказ грошей з одного рахунку на другий.";
